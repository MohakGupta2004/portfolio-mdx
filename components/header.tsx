...
const Header = () => {
  ...
  return (
    <header className="md:hidden container mx-auto max-w-3xl px-4 sm:px-6 md:px-8 sticky top-0 z-50 py-4 bg-background/90 backdrop-blur-sm border-b border-border/30">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 text-foreground hover:bg-muted/50 transition-all duration-200"
